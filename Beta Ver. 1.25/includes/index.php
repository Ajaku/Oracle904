...
<?php
	echo '
		...
		<meta name="keywords" content="Oracle904, pso2, phantasy star online2, ss, 加工, 自キャラ" />
		...
		<meta name="twitter:site" content="@Ajaku_PSO2">
		...
		<meta name="twitter:image" content="http://oracle904.luna.ddns.vc/images/home.png">
	</head>
<body>
	<div id="static-index">
		<h1 style="font-size: 45px; margin-top: 3em;"><a href="'.$site_url.'">'.$site_url3.'</a></h1>';
...
<?php
	...
	echo '<br /><br /><small style="color: #777777;">Original source by <a href="Danbooru">Danbooru</a></small></div></div>
	</body>
</html>';
