<?php
	...
	$ccount = 0;
	print '<table class="highlightable" style="width: 100%;"><tr><th width="25%"><b>Alias:<small> (What you search for...)</small></b></th><th width="25%"><b>Tag:</b><small> (What it should be...)</small></th><th>Reason:</th></tr>';
	...
	<b>Search term:</b></td><td><input type="text" name="alias" value=""/></td></tr>
	<tr><td><b>Alias for:</b></td><td><input type="text" name="tag" value=""/></td></tr>
	</table>
...
<html>
	<head>
		...
		<ins class="adsbygoogle"
    		 style="display:block"
    		 data-ad-client="ca-pub-6185538497842353"
     		data-ad-slot="3593043829"
