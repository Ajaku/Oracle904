<?php
	echo '
		<title>Add Post | '.$site_url3.'</title>
...
?>
	...
	<p>SS画像には必ず(C)SEGA, PHANTASY STAR ONLINE 2 の記述をお願いします。
	<p style="color:red;">ファイルのアップロードは最大3MBまでです。</p>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;タグはスペースで区切るようにしてください。 (ex: green_eyes purple green_hair)
	</td></tr>
	<tr><td>
	Rating:<br />
	<input type="radio" name="rating" value="e" />Explicit
	<input type="radio" name="rating" value="q" />Questionable
	<input type="radio" name="rating" value="s" checked="true" />Safe
	</td></tr>
	<tr><td>
	My Tags:<br />
