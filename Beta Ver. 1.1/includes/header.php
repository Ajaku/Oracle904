<?php
	...
	<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
		<link rel="shortcut icon" href="/oracle904/favicon.ico">
		<link rel="apple-touch-icon" href="/oracle904/images/favicon.png" />
	<head>
	<title>'.$site_url3.'';
...
<body>
	<div id="header">
		<h1><a href="'.$site_url.'index.php">'.$site_url3.'</a></h1>
