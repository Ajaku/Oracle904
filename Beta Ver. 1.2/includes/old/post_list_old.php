...
<input id="tags" name="tags" size="18" type="text" value="<?php if(isset($_GET['tags']) && $_GET['tags'] != "all"){ print str_replace("%",'',str_replace("'","&#039;",str_replace('"','&quot;',$_GET['tags'])));}?>" />
