...
<?php
	echo '
		<title>View '.$tags.'  | '.$site_url3.'</title>
	...
	else
	{
		...
		if($post_data['spam'] == false)
			echo '<a id="rp'.$id.'"></a><a href="#" id="rpl'.$id.'" onclick="Element.toggle(\'report_form\')">Report post.</a><br /><br /><form id="report_form" method="post" action="./public/report.php?type=post&amp;rid='.$id.'" style="display: none;">Reason for report:<br /><input type="text" name="reason" value=""/><input type="submit" name="submit" value="" style="display: none;"/></form>';
		else
...
<?php
		...
		//]]></script></div><a href="#" onclick="Javascript:showHide(\'comment_form\'); return false;">>>Comment</a>
